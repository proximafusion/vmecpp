...
## Testing Results
- [done] PT_TYPE fields successfully added to C++ structures
- [done] HDF5 I/O implemented and functional
- [done] JSON parsing implemented
- [done] Python bindings expose all fields
- [done] Confirmed fields are available in VmecInput.__annotations__
