...
### Already Implemented:
1. OK Lambda asymmetric coefficients (lmncc, lmnss)
2. OK Force symmetrization (symforce)
3. OK M=1 constraint coupling for asymmetric
4. OK Full toroidal domain axis optimization
