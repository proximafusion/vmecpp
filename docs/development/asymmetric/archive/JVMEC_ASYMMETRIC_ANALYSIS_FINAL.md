...
1. OK Asymmetric Fourier transforms (totzspa, symrzl, tomnspa, symforce)
2. OK M=1 constraint handling for asymmetric
3. OK Force symmetrization
4. OK Spectral condensation for asymmetric
5. OK Boundary condition handling
6. OK Array allocations and state management
