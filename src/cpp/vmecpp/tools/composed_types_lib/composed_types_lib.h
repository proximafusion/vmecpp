#ifndef VMECPP_TOOLS_COMPOSED_TYPES_LIB_COMPOSED_TYPES_LIB_H_
#define VMECPP_TOOLS_COMPOSED_TYPES_LIB_COMPOSED_TYPES_LIB_H_
...
#endif  // VMECPP_TOOLS_COMPOSED_TYPES_LIB_COMPOSED_TYPES_LIB_H_
