#ifndef fftx_iprdftbat_PUBLIC_cpu_HEADER_INCLUDED
#define fftx_iprdftbat_PUBLIC_cpu_HEADER_INCLUDED
...
#define fftx_iprdftbat_QuerySizes fftx_iprdftbat_cpu_QuerySizes
...
void fftx_iprdftbat_cpu_Run(fftx::point_t<4> req, double *output,
                            double *input);
#define fftx_iprdftbat_Run fftx_iprdftbat_cpu_Run
...
#define fftx_iprdftbat_Tuple fftx_iprdftbat_cpu_Tuple
