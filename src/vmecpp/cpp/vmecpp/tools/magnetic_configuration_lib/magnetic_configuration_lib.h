#ifndef VMECPP_TOOLS_MAGNETIC_CONFIGURATION_LIB_MAGNETIC_CONFIGURATION_LIB_H_
#define VMECPP_TOOLS_MAGNETIC_CONFIGURATION_LIB_MAGNETIC_CONFIGURATION_LIB_H_
...
#endif  // VMECPP_TOOLS_MAGNETIC_CONFIGURATION_LIB_MAGNETIC_CONFIGURATION_LIB_H_
