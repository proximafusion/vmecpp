        ...
        switch (current_carrier.type_case()) {
          ...
          case CurrentCarrier::TypeCase::kFourierFilament: {
            absl::StatusOr<PolygonFilament> polygon_filament =
                ToPolygonFilament(current_carrier.fourier_filament());
            if (!polygon_filament.ok()) {
              return polygon_filament.status();
            }
            AddMagneticField(*polygon_filament, current, evaluation_positions,
                             contribution);
            break;
          }
      ...
      for (const CurrentCarrier& current_carrier : coil.current_carriers()) {
        ...
        switch (current_carrier.type_case()) {
          ...
          case CurrentCarrier::TypeCase::kFourierFilament: {
            ...
            AddVectorPotential(*polygon_filament, current, evaluation_positions,
                               contribution);
            break;
          }
          case CurrentCarrier::TypeCase::kTypeNotSet:
