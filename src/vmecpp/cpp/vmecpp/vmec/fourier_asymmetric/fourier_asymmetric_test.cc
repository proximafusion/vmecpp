...
TEST(FourierAsymmetricTest, EnsureM1ConstrainedSymmetric) {
...
TEST(FourierAsymmetricTest, EnsureM1ConstrainedAsymmetric) {
...
TEST(FourierAsymmetricTest, ConvertToM1Constrained) {
