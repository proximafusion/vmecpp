...
absl::Status vmecpp::WOutFileContents::WriteTo(H5::H5File& file) const {
  ...
  WRITEMEMBER(itfsq);
  WRITEMEMBER(fsqt);
  WRITEMEMBER(force_residual_r);
  WRITEMEMBER(force_residual_z);
  WRITEMEMBER(force_residual_lambda);
  WRITEMEMBER(delbsq);
  WRITEMEMBER(restart_reason_timetrace);
  WRITEMEMBER(wdot);
  WRITEMEMBER(iotaf);
...
absl::Status vmecpp::WOutFileContents::LoadInto(WOutFileContents& m_obj,
  ...
  READMEMBER(fsqz);
  READMEMBER(fsql);
  READMEMBER_OPTIONAL(itfsq);
  READMEMBER_OPTIONAL(fsqt);
  READMEMBER_OPTIONAL(force_residual_r);
  READMEMBER_OPTIONAL(force_residual_z);
  READMEMBER_OPTIONAL(force_residual_lambda);
  READMEMBER_OPTIONAL(delbsq);
  READMEMBER_OPTIONAL(restart_reason_timetrace);
  READMEMBER_OPTIONAL(wdot);
