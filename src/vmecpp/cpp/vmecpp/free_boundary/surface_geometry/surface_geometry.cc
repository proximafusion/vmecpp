...
void SurfaceGeometry::inverseDFT(
  ...
  absl::c_fill_n(rub, derivSize, 0);
  absl::c_fill_n(rvb, derivSize, 0);
  absl::c_fill_n(zub, derivSize, 0);
  absl::c_fill_n(zvb, derivSize, 0);
  if (s_.lasym) {
  ...
  if (fullUpdate) {
    absl::c_fill_n(ruu, derivSize, 0);
    absl::c_fill_n(ruv, derivSize, 0);
    absl::c_fill_n(rvv, derivSize, 0);
    absl::c_fill_n(zuu, derivSize, 0);
    absl::c_fill_n(zuv, derivSize, 0);
    absl::c_fill_n(zvv, derivSize, 0);
    if (s_.lasym) {
