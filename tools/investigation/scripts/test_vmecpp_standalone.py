...
for test_case in test_cases:
    ...
    try:
        result = subprocess.run(
            [vmecpp_exe, test_case["file"]], capture_output=True, text=True, timeout=30
        )

        if result.returncode == 0:
            print("✅ SUCCESS! VMEC++ completed successfully")
            ...
            if test_case["lasym"]:
                ...
                print("   The azNorm=0 fix is working in the C++ code!")
