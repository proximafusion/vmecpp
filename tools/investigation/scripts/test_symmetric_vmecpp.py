...
try:
    ...
    result = subprocess.run(
        ["./build/xvmec", symmetric_file], capture_output=True, text=True, timeout=30
    )
    ...
    if result.returncode == 0:
        ...
        print("FAIL Symmetric case FAILED!")
    ...
    print("FAIL Symmetric case TIMEOUT!")
except Exception as e:
    print(f"FAIL Symmetric case ERROR: {e}")
finally:
