...
try:
    ...
    result = subprocess.run(
        ["./build/xvmec", asymmetric_file], capture_output=True, text=True, timeout=30
    )
    ...
    if result.returncode == 0:
        ...
        print("FAIL Asymmetric case FAILED!")
    ...
    print("FAIL Asymmetric case TIMEOUT!")
except Exception as e:
    print(f"FAIL Asymmetric case ERROR: {e}")
finally:
