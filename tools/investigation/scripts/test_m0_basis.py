...
print("  Expected R(0) = 1.3")
print("  Actual R(0) = 1.424264")
...
print()
print(
    "The problem: For physical values, we want cos(m*theta), not cos(m*theta)*mscale[m]"
)
print(
    "The mscale normalization is for internal transform consistency, not physical output."
)
