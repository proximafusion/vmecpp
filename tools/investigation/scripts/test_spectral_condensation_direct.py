...
try:
    ...
    print(
        "The spectral condensation arrays are being computed correctly for asymmetric cases."
    )
    ...
    if "spectral" in error_msg.lower() or "condens" in error_msg.lower():
        ...
        if "not spectrally condensed enough" in error_msg:
            ...
            print(
                "The spectral condensation arrays are not being populated in the asymmetric transform."
            )
    else:
