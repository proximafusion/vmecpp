...
try:
    ...
    config_sym.rbc = [{"m": 0, "n": 0, "value": 10.0}, {"m": 1, "n": 0, "value": 1.0}]
    config_sym.zbs = [{"m": 1, "n": 0, "value": 1.0}]
...
try:
    ...
    config_asym.rbc = [{"m": 0, "n": 0, "value": 10.0}, {"m": 1, "n": 0, "value": 1.0}]
    config_asym.zbs = [{"m": 1, "n": 0, "value": 1.0}]
    ...
    config_asym.zbc = [{"m": 1, "n": 0, "value": 0.01}]
    ...
    print("OK Asymmetric case PASSED!")
    print(f"  Beta: {result.beta:.6f}")
    print(f"  Energy: {result.w_mhd:.6f}")
    print(f"  Aspect ratio: {result.aspect_ratio:.3f}")

except Exception as e:
    print(f"FAIL Asymmetric case FAILED: {e}")
