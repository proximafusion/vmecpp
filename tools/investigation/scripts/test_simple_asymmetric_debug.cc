...
TEST(AsymmetricDebug, SimpleAsymmetricTokamak) {
  ...
  indata.rbs[vmecpp::VmecINDATA::ntord + 0][1] =
      0.001;  // Small asymmetric perturbation
  ...
  std::cout << "R00 = " << indata.rbc[vmecpp::VmecINDATA::ntord + 0][0]
            << std::endl;
  std::cout << "R01 = " << indata.rbc[vmecpp::VmecINDATA::ntord + 0][1]
            << std::endl;
  std::cout << "RBS01 = " << indata.rbs[vmecpp::VmecINDATA::ntord + 0][1]
            << " (asymmetric)" << std::endl;
  std::cout << "Z01 = " << indata.zbs[vmecpp::VmecINDATA::ntord + 0][1]
            << std::endl;
